...
public class Register extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        File file = new File("C:\\Users\\HP\\IdeaProjects\\assignment3JAVA\\src\\main\\java\\db.txt");
    ...
    private void saveUserList() throws IOException {
        ...
        Files.write(Paths.get("C:\\Users\\HP\\IdeaProjects\\assignment3JAVA\\src\\main\\java\\db.txt"), content.getBytes());
        UserList.clear();
    }
}
